...
ENV_ARGS="WANDB_DISABLED=true TORCH_CPP_LOG_LEVEL=INFO NCCL_DEBUG=INFO TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=1"
...
$ENV_ARGS torchrun $DISTRIBUTED_ARGS pretrain_gpt.py \
    $GPT_ARGS \
    $DATA_ARGS \
    $OUTPUT_ARGS \
    $PARALLELISM_ARGS \
